"""
Django settings for accountkitdemo project.
...
PROJECT_DIR = join(BASE_DIR, 'accountkitdemo')
...
ROOT_URLCONF = 'accountkitdemo.urls'

WSGI_APPLICATION = 'accountkitdemo.wsgi.application'
